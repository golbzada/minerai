...
async function saveCapturedOffer(offerData) {
  ...
  const adsCount = parseInt(offerData.adsCount, 10) || 1;
  const runningDays = parseInt(offerData.daysRunning, 10) || 1;
  ...
  const payload = {
    ...
    destination_url: offerData.landingPage || offerData.libraryUrl || '',
    affiliate_link: '',
